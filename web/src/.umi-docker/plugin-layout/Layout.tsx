...
export default props => {
  ...
  const userConfig = {
    ...{'name':'ant-design-pro','theme':'PRO','locale':true,'showBreadcrumb':true,'siderWidth':208,'navTheme':'dark','primaryColor':'#1890ff','layout':'side','contentWidth':'Fluid','fixedHeader':true,'fixSiderbar':true,'pwa':false,'logo':'https://gw.alipayobjects.com/zos/rmsportal/KDpgvguMpGfqaHPjicRK.svg','headerHeight':48,'splitMenus':false,'title':'RiDX'},
    ...runtimeConfig || {}
  };
