...
import CustomFlow from '../assessments/$id/attack_graph/CustomFlow';
    ...
    return (
      <Tabs defaultActiveKey="1">
        ...
        <TabPane tab="Assets" key="2">
          <Table columns={columnsAsset} dataSource={dataAsset} />
        </TabPane>
        <TabPane tab="Security goals" key="3">
          <Table columns={columnsSecurityGoal} dataSource={dataSecurityGoal} />
        </TabPane>
        ...
        <TabPane tab="Countermeasures" key="5">
          <Table columns={columnsCountermeasure} dataSource={dataCountermeasure} />
        </TabPane>
      </Tabs>
    );
  } else {
